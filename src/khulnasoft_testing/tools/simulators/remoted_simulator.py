...
from khulnasoft_testing.constants.paths.configurations import KHULNASOFT_CLIENT_KEYS_PATH
from khulnasoft_testing.tools.mitm import ManInTheMiddle
from khulnasoft_testing.utils import secure_message
from khulnasoft_testing.utils.client_keys import get_client_keys
...
class RemotedSimulator(BaseSimulator):
    ...
    from a Khulnasoft server using a ManInTheMiddle object. It also allows to specify different modes of
    ...
    def __init__(self,
                 ...
                 keys_path: str = KHULNASOFT_CLIENT_KEYS_PATH) -> None:
        """
        Initialize a RemotedSimulator object.

        Args:
            server_ip (str, optional): The IP address of the Khulnasoft server. Defaults: '127.0.0.1'.
            port (int, optional): The port number of the Khulnasoft server. Defaults: 1514.
            ...
            keys_path (str, optional): The path to the khulnasoft client keys file. Defaults: BASE_CONF_PATH/client.keys'.
        """
    ...
    def send_custom_message(self, message: Union[str, bytes]) -> None:
        """
        Send a custom message to the connected khulnasoft agent.
