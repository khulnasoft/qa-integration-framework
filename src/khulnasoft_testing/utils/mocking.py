...
from khulnasoft_testing.constants.paths.sockets import QUEUE_DB_PATH
from khulnasoft_testing.utils import client_keys, file, services
from khulnasoft_testing.utils.db_queries import global_db, agent_db
...
def create_mocked_agent(name='centos8-agent', ip='127.0.0.1', register_ip='127.0.0.1', internal_key='',
                        ...
                        os_uname='x64', os_arch='x64', version='Khulnasoft v4.3.0', config_sum='', merged_sum='',
    ...
    # Restart Khulnasoft-DB before creating new DB
