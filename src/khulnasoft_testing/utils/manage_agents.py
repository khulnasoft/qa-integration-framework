...
from khulnasoft_testing.constants.api import AGENTS_ROUTE
from khulnasoft_testing.constants.paths.binaries import MANAGE_AGENTS_BINARY
from khulnasoft_testing.modules.api.utils import login, get_base_url
from khulnasoft_testing.utils.db_queries.global_db import delete_agent


def remove_agents(agents_id: List, remove_type: str = 'khulnasoftdb') -> None:
    ...
    """
    if remove_type not in ('khulnasoftdb', 'manage_agents', 'api'):
