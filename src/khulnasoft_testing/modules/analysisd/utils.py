...
from khulnasoft_testing.constants.keys.alerts import *
from khulnasoft_testing.constants.keys.events import *
from khulnasoft_testing.constants.paths.variables import ANALYSISD_STATE
from khulnasoft_testing.constants.platforms import LINUX, WINDOWS
...
def get_analysisd_state():
    """Get the states values of khulnasoft-analysisd.state file
